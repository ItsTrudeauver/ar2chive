  ...
  return (
    <div className="app">
      <Helmet>
        ...
        <meta property="og:description" content="A sleek archive of community-recommended books, indexed by category and importance." />
        ...
        <meta name="twitter:description" content="A sleek archive of community-recommended books." />
